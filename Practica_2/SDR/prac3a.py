...
class prac3a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/com2_B1_G7/Descargas/sonido.wav', True, 0, 0)
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.blocks_null_sink_0, 0))
